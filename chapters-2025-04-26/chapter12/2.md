...
A. Agent, Environment, Action, Reward, Policy
B. Supervised Learning, Unsupervised Learning, Semi-supervised Learning
C. Data Collection, Model Training, Evaluation
D. Input, Output, Feedback, Adjustment
...
B. It aligns models with human preferences
...
A. Generating words in a sentence
B. Collecting data
...
A. To provide feedback on actions
